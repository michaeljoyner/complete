...
var ScrollAlerter = function ScrollAlerter(els) {
    this.listeners = els;
};
...
ScrollAlerter.prototype.isInViewport = function (el) {
    ...
    return rect.top < 100 && rect.top >= 0 && rect.left >= 0
...
window.ScrollAlerter = require('./components/scrollalerter.js');

},{"./components/scrollalerter.js":3,"./contactform.js":4}]},{},[5]);
